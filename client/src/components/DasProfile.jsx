...
import { updateStart, updateSuccess, updateFailure, deleteStart, deleteSuccess, deleteFailure, signoutSuccess } from '../features/user/userSlice.js';
  ...
  return (
    <div className='max-w-lg mx-auto p-3 w-full'>
      ...
      <Modal show={showModel} onClose={() => setShowModel(false)} popup size='md'>
        <Modal.Header className='text-gray-700 dark:text-gray-200'>Delete User</Modal.Header>
        <Modal.Body>
